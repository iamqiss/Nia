...
#ifndef time_NOTE_WEBSOCKET_HANDLER_H
#define time_NOTE_WEBSOCKET_HANDLER_H
...
public:
    ...
    explicit NoteWebSocketHandler(
        ...
        std::shared_ptr<time::note::services::NotificationService> notification_service,
     ...
     */
    void handle_connection(std::shared_ptr<time::core::network::WebSocketConnection> connection);
     ...
     */
    void handle_disconnection(std::shared_ptr<time::core::network::WebSocketConnection> connection);
     ...
     */
    void handle_message(std::shared_ptr<time::core::network::WebSocketConnection> connection, 
     ...
     */
    void subscribe_to_timeline(std::shared_ptr<time::core::network::WebSocketConnection> connection,
     ...
     */
    void subscribe_to_engagement(std::shared_ptr<time::core::network::WebSocketConnection> connection,
     ...
     */
    void subscribe_to_notifications(std::shared_ptr<time::core::network::WebSocketConnection> connection,
                                   const std::vector<std::string>& notification_types);

    /**
     * @brief Unsubscribe from updates
     */
    void unsubscribe(std::shared_ptr<time::core::network::WebSocketConnection> connection,
     ...
     */
    void unsubscribe_all(std::shared_ptr<time::core::network::WebSocketConnection> connection);
...
private:
    ...
    std::shared_ptr<time::note::services::TimelineService> timeline_service_;
    std::shared_ptr<time::note::services::NotificationService> notification_service_;
    std::shared_ptr<time::core::cache::RedisClient> redis_client_;
    std::shared_ptr<time::core::security::AuthService> auth_service_;
    ...
    std::unordered_map<std::string, std::vector<std::shared_ptr<time::core::network::WebSocketConnection>>> user_connections_;
    ...
    std::unordered_map<std::string, std::vector<std::shared_ptr<time::core::network::WebSocketConnection>>> timeline_subscriptions_;
    
    // Engagement subscriptions: note_id -> list of connections
    std::unordered_map<std::string, std::vector<std::shared_ptr<time::core::network::WebSocketConnection>>> engagement_subscriptions_;
    
    // Notification subscriptions: user_id -> list of connections
    std::unordered_map<std::string, std::vector<std::shared_ptr<time::core::network::WebSocketConnection>>> notification_subscriptions_;
    ...
    std::string authenticate_connection(std::shared_ptr<time::core::network::WebSocketConnection> connection);
    ...
    void handle_subscribe_message(std::shared_ptr<time::core::network::WebSocketConnection> connection, const json& data);
    void handle_unsubscribe_message(std::shared_ptr<time::core::network::WebSocketConnection> connection, const json& data);
    void handle_typing_message(std::shared_ptr<time::core::network::WebSocketConnection> connection, const json& data);
    void handle_ping_message(std::shared_ptr<time::core::network::WebSocketConnection> connection, const json& data);

    // Connection management
    std::string generate_connection_id(std::shared_ptr<time::core::network::WebSocketConnection> connection);
    void register_connection(std::shared_ptr<time::core::network::WebSocketConnection> connection, const std::string& user_id);
    void unregister_connection(std::shared_ptr<time::core::network::WebSocketConnection> connection);
    void cleanup_dead_connections();
    bool is_connection_alive(std::shared_ptr<time::core::network::WebSocketConnection> connection);

    // Subscription management
    void add_subscription(std::shared_ptr<time::core::network::WebSocketConnection> connection,
                         const std::string& subscription_type,
                         const std::string& identifier);
    void remove_subscription(std::shared_ptr<time::core::network::WebSocketConnection> connection,
                            const std::string& subscription_type,
                            const std::string& identifier);
    std::vector<std::shared_ptr<time::core::network::WebSocketConnection>> get_subscribers(
        const std::string& subscription_type, const std::string& identifier);

    // Broadcasting helpers
    void send_message_to_connection(std::shared_ptr<time::core::network::WebSocketConnection> connection, const json& message);
    ...
    // Error handling
    void handle_connection_error(std::shared_ptr<time::core::network::WebSocketConnection> connection, const std::string& error);
...
#endif // time_NOTE_WEBSOCKET_HANDLER_H
