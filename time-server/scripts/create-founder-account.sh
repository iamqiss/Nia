...
# time Founder Account Creation Script
...
# Account details (these would normally be provided interactively)
...
main() {
    log "Starting time founder account creation..."
    
    # Pre-creation checks
    check_root
    check_prerequisites
    
    log "Creating founder account for: $DISPLAY_NAME (@$USERNAME)"
    log "Email: $EMAIL"
    log ""
