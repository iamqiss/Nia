...
router.patch('/me', requireAuth, async (req, res, next) => {
    try {
        ...
        if (parsed.bannerUrl !== undefined)
            data.bannerUrl = parsed.bannerUrl;
        if (parsed.isProtected !== undefined)
            data.isProtected = parsed.isProtected;
        if (parsed.isDiscoverable !== undefined)
            data.isDiscoverable = parsed.isDiscoverable;
