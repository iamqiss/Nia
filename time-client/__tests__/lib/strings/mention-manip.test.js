import { getMentionAt, insertMentionAt, } from '../../../src/lib/strings/mention-manip';
describe('getMentionAt', () => {
    ...
    it.each(cases)('given input string %p and cursor position %p, returns %p', (str, cursorPos, expected) => {
...
//# sourceMappingURL=mention-manip.test.js.map