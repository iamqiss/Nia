 ...
 */
export const RELEASE_VERSION = process.env.EXPO_PUBLIC_RELEASE_VERSION || packageJson.version;
/**
 ...
 */
export const BUNDLE_DATE = process.env.EXPO_PUBLIC_BUNDLE_DATE === undefined
    ? 0
 ...
 */
export const BLUESKY_PROXY_DID = process.env.EXPO_PUBLIC_BLUESKY_PROXY_DID || 'did:web:api.bsky.app';
/**
 * The DID of the chat service to proxy to
 */
export const CHAT_PROXY_DID = process.env.EXPO_PUBLIC_CHAT_PROXY_DID || 'did:web:api.bsky.chat';
/**
 ...
 */
export const BITDRIFT_API_KEY = process.env.EXPO_PUBLIC_BITDRIFT_API_KEY;
/**
 * GCP project ID which is required for native device attestation. On web, this
 * should be unset and evaluate to 0.
 */
export const GCP_PROJECT_ID = process.env.EXPO_PUBLIC_GCP_PROJECT_ID === undefined
    ? 0
 ...
 */
export const BAPP_CONFIG_DEV_BYPASS_SECRET = process.env.BAPP_CONFIG_DEV_BYPASS_SECRET;
