...
const MODERATION_AUTHORITIES_DIDS = Array.from(new Set(Object.values(MODERATION_AUTHORITIES).flat()));
...
export function configureAdditionalModerationAuthorities() {
    ...
    // default to all
    let additionalLabelers = MODERATION_AUTHORITIES_DIDS;
...
//# sourceMappingURL=additional-moderation-authorities.js.map