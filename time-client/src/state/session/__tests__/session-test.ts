...
describe('session', () => {
  it('can log in and out', () => {
    ...
    const agent = new TimeGrpcClient({service: 'https://alice.com'})
  ...
  it('switches to the latest account, stores all of them', () => {
    ...
    const agent1 = new TimeGrpcClient({service: 'https://alice.com'})
    ...
    const agent2 = new TimeGrpcClient({service: 'https://bob.com'})
    ...
    const agent3 = new TimeGrpcClient({service: 'https://alice.com'})
    ...
    const agent4 = new TimeGrpcClient({service: 'https://jay.com'})
  ...
  it('can log back in after logging out', () => {
    ...
    const agent2 = new TimeGrpcClient({service: 'https://alice.com'})
    agent2.sessionManager.session = {
      active: true,
      did: 'alice-did',
      handle: 'alice.test',
  ...
  it('replaces local accounts with synced accounts', () => {
    ...
    const anotherTabAgent1 = new TimeGrpcClient({service: 'https://jay.com'})
    ...
    const anotherTabAgent2 = new TimeGrpcClient({service: 'https://alice.com'})
    ...
    const anotherTabAgent3 = new TimeGrpcClient({service: 'https://clarence.com'})
