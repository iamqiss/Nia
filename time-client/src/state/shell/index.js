...
export function Provider({ children }) {
    return (_jsx(ShellLayoutProvder, { children: _jsx(DrawerOpenProvider, { children: _jsx(DrawerSwipableProvider, { children: _jsx(MinimalModeProvider, { children: _jsx(ColorModeProvider, { children: _jsx(OnboardingProvider, { children: _jsx(TickEveryMinuteProvider, { children: children }) }) }) }) }) }) }));
}
