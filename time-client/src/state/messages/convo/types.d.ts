import { type BskyAgent, type ChatBskyActorDefs, type ChatBskyConvoDefs, type ChatBskyConvoSendMessage } from '@atproto/api';
...
export declare enum ConvoStatus {
...
export declare enum ConvoItemError {
    /**
...
export declare enum ConvoErrorCode {
...
export declare enum ConvoDispatchEvent {
    Init = "init",
    Ready = "ready",
    Resume = "resume",
...
export type ConvoState = ConvoStateUninitialized | ConvoStateInitializing | ConvoStateReady | ConvoStateBackgrounded | ConvoStateSuspended | ConvoStateError | ConvoStateDisabled;
