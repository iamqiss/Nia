import { type AppBskyFeedDefs, type AppBskyGraphDefs, type AppBskyNotificationListNotifications } from '@atproto/api';
export type NotificationType = StarterPackNotificationType | OtherNotificationType;
export type FeedNotification = (FeedNotificationBase & {
...
type OtherNotificationType = 'post-like' | 'repost' | 'mention' | 'reply' | 'quote' | 'follow' | 'feedgen-like' | 'verified' | 'unverified' | 'like-via-repost' | 'repost-via-repost' | 'subscribed-post' | 'unknown';
