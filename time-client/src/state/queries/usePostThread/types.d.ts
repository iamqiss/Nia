import { type AppBskyFeedDefs, type AppBskyFeedPost, type AppBskyFeedThreadgate, type AppBskyUnspeccedDefs, type AppBskyUnspeccedGetPostThreadOtherV2, type AppBskyUnspeccedGetPostThreadV2, type ModerationDecision } from '@atproto/api';
export type ApiThreadItem = AppBskyUnspeccedGetPostThreadV2.ThreadItem | AppBskyUnspeccedGetPostThreadOtherV2.ThreadItem;
export declare const postThreadQueryKeyRoot: "post-thread-v2";
export declare const createPostThreadQueryKey: (props: PostThreadParams) => readonly ["post-thread-v2", PostThreadParams];
export declare const createPostThreadOtherQueryKey: (props: Omit<AppBskyUnspeccedGetPostThreadOtherV2.QueryParams, "anchor"> & {
    anchor?: string;
}) => readonly ["post-thread-v2", "other", Omit<AppBskyUnspeccedGetPostThreadOtherV2.QueryParams, "anchor"> & {
    anchor?: string;
}];
export type PostThreadParams = Pick<AppBskyUnspeccedGetPostThreadV2.QueryParams, 'sort' | 'prioritizeFollowedUsers'> & {
    anchor?: string;
    view: 'tree' | 'linear';
};
