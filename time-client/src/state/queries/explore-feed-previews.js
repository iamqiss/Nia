...
const RQKEY = (feeds) => [RQKEY_ROOT, feeds];
...
export function useFeedPreviews(feedsMaybeWithDuplicates, isEnabled = true) {
    const feeds = useMemo(() => feedsMaybeWithDuplicates.filter((f, i, a) => i === a.findIndex(f2 => f.uri === f2.uri)), [feedsMaybeWithDuplicates]);
...
//# sourceMappingURL=explore-feed-previews.js.map