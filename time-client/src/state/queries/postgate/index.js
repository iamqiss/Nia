...
export async function getPostgateRecord({ agent, postUri, }) {
...
export async function writePostgateRecord({ agent, postUri, postgate, }) {
...
export async function upsertPostgate({ agent, postUri, }, callback) {
...
export const createPostgateQueryKey = (postUri) => [
    'postgate-record',
    postUri,
];
export function usePostgateQuery({ postUri }) {
...
export function useWritePostgateMutation() {
    ...
    return useMutation({
        mutationFn: async ({ postUri, postgate, }) => {
...
export function useToggleQuoteDetachmentMutation() {
    ...
    const prevEmbed = React.useRef(undefined);
    return useMutation({
        mutationFn: async ({ post, quoteUri, action, }) => {
...
export function useToggleQuotepostEnabledMutation() {
    const agent = useAgent();
    return useMutation({
        mutationFn: async ({ postUri, action, }) => {
