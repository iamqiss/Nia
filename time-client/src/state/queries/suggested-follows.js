...
export function useSuggestedFollowsQuery(options) {
    ...
    return useInfiniteQuery({
        ...
        queryFn: async ({ pageParam }) => {
            ...
            const maybeDifferentLimit = options?.subsequentPageLimit && pageParam
...
export function useSuggestedFollowsByActorQuery({ did, enabled, staleTime = STALE.MINUTES.FIVE, }) {
    const agent = useAgent();
    return useQuery({
        staleTime,
...
//# sourceMappingURL=suggested-follows.js.map