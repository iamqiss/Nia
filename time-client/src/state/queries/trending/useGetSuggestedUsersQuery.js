...
export const createGetSuggestedUsersQueryKey = (props) => [
    ...
    return useQuery({
        ...
        queryFn: async () => {
            ...
            const { data } = await agent.app.bsky.unspecced.getSuggestedUsers({
                ...
                headers: {
                    ...createBskyTopicsHeader(props.overrideInterests && props.overrideInterests.length > 0
                        ? props.overrideInterests.join(',')
                        : interests),
...
//# sourceMappingURL=useGetSuggestedUsersQuery.js.map