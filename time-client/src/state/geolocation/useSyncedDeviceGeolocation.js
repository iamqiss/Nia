...
export function useSyncedDeviceGeolocation() {
    ...
    useEffect(() => {
        async function get() {
            ...
            if (status?.granted) {
                 ...
                 */
                if (hasCachedValue) {
                    logger.debug('useSyncedDeviceGeolocation: clearing cached location, perms revoked');
    ...
    return [deviceGeolocation, setDeviceGeolocation];
}
//# sourceMappingURL=useSyncedDeviceGeolocation.js.map