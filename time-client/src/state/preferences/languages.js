...
const stateContext = React.createContext(persisted.defaults.languagePrefs);
stateContext.displayName = 'LanguagePrefsStateContext';
const apiContext = React.createContext({
    setPrimaryLanguage: (_) => { },
    setPostLanguage: (_) => { },
    setContentLanguage: (_) => { },
    toggleContentLanguage: (_) => { },
    togglePostLanguage: (_) => { },
        ...
        savePostLanguageToHistory() {
            ...
            setStateWrapped(s => ({
                ...
                postLanguageHistory: [s.postLanguage]
                    .concat(s.postLanguageHistory.filter(commaSeparatedLangCodes => commaSeparatedLangCodes !== s.postLanguage))
                    .slice(0, 6),
            }));
        },
        setAppLanguage(code2) {
