    ...
    <View style={[a.pt_xs]}>
      <Admonition type="tip">
        <Trans>
          You also agree to{' '}
          <InlineLinkText
            label={_(msg`Time's Community Guidelines`)}
            to={webLinks.communityDeprecated}>
            Time’s Community Guidelines
          </InlineLinkText>
          . An{' '}
          <InlineLinkText
            label={_(msg`Time's Updated Community Guidelines`)}
  ...
  if (tos && pp) {
    els = (
      <Trans>
        ...
        <InlineLinkText
          label={_(msg`Read the Time Terms of Service`)}
          key="tos"
          to={tos}>
          Terms of Service
        </InlineLinkText>{' '}
        and{' '}
        <InlineLinkText
          label={_(msg`Read the Time Privacy Policy`)}
          key="pp"
          to={pp}>
          Privacy Policy
        </InlineLinkText>
