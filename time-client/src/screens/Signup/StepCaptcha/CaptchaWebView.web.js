...
export function CaptchaWebView({ url, stateParam, onSuccess, onError, }) {
    React.useEffect(() => {
    ...
    const onLoad = React.useCallback(() => {
        // @ts-ignore web
        const frame = document.getElementById('captcha-iframe');
        try {
            // @ts-ignore web
...
//# sourceMappingURL=CaptchaWebView.web.js.map