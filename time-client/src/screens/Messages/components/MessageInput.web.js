...
export function MessageInput({ onSendMessage, hasEmbed, setEmbed, children, openEmojiPicker, }) {
    ...
    const onEmojiInserted = React.useCallback((emoji) => {
    ...
    return (_jsxs(View, { style: a.p_sm, children: [children, _jsxs(View, { style: [
                ...
                onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), children: [_jsx(Button, { onPress: e => {
                        ...
                        ], label: _(msg `Open emoji picker`), children: state => (_jsx(View, { style: [
                                a.absolute,
                                a.inset_0,
                                a.align_center,
                                a.justify_center,
                            ...
                            ], children: _jsx(EmojiSmile, { size: "lg" }) })) }), _jsx(TextareaAutosize, { ref: textAreaRef, style: StyleSheet.flatten([
                            a.flex_1,
                            a.px_sm,
                            a.border_0,
                            t.atoms.text,
                        ...
                        ]), maxRows: 12, placeholder: _(msg `Write a message`), defaultValue: "", value: message, dirName: "ltr", autoFocus: true, onFocus: () => setIsFocused(true), onBlur: () => setIsFocused(false), onCompositionStart: () => {
                            isComposing.current = true;
                        }, onCompositionEnd: () => {
                            isComposing.current = false;
                        }, onHeightChange: height => setTextAreaHeight(height), onChange: onChange, 
                        // On mobile web phones, we want to keep the same behavior as the native app. Do not submit the message
                        // in these cases.
                        onKeyDown: isTouchDevice && isMobile ? undefined : onKeyDown }), _jsx(Pressable, { accessibilityRole: "button", accessibilityLabel: _(msg `Send message`), accessibilityHint: "", style: [
                            a.rounded_full,
                            a.align_center,
                            a.justify_center,
                            {
...
//# sourceMappingURL=MessageInput.web.js.map