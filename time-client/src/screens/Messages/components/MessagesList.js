...
function MaybeLoader({ isLoading }) {
...
export function MessagesList({ hasScrolled, setHasScrolled, blocked, footer, hasAcceptOverride, }) {
    ...
    const onContentSizeChange = useCallback((_, height) => {
    ...
    const onOpenEmojiPicker = useCallback((pos) => {
...
function ConversationFooter({ convoState, hasAcceptOverride, children, }) {
