...
export function MessageInput({ onSendMessage, hasEmbed, setEmbed, children, }) {
    const { _ } = useLingui();
    const t = useTheme();
    ...
    return (_jsxs(View, { style: [a.px_md, a.pb_sm, a.pt_xs], children: [children, _jsxs(View, { style: [
                    ...
                    isFocused && inputStyles.chromeFocus,
                ], children: [_jsx(AnimatedTextInput, { accessibilityLabel: _(msg `Message input field`), accessibilityHint: _(msg `Type your message here`), placeholder: _(msg `Write a message`), placeholderTextColor: t.palette.contrast_500, value: message, onChange: evt => {
                            ...
                            animatedStyle,
                        ], keyboardAppearance: t.scheme, submitBehavior: "newline", onFocus: () => setIsFocused(true), onBlur: () => setIsFocused(false), ref: inputRef, hitSlop: HITSLOP_10, animatedProps: animatedProps, editable: !needsEmailVerification }), _jsx(Pressable, { accessibilityRole: "button", accessibilityLabel: _(msg `Send message`), accessibilityHint: "", hitSlop: HITSLOP_10, style: [
                            a.rounded_full,
                            a.align_center,
                            a.justify_center,
