 ...
 * ```
 */
export declare function dangerousIsType<R extends {
    $type?: string;
}>(record: unknown, identity: <V>(v: V) => v is V & {
    $type: NonNullable<R['$type']>;
}): record is R;
/**
 ...
 * ```
 */
export declare function validate<R extends {
    $type?: string;
}>(record: unknown, validator: (v: unknown) => ValidationResult<R>): record is R;
