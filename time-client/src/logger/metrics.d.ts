...
export type MetricEvents = {
    ...
    'account:loggedIn': {
        logContext: 'LoginForm' | 'SwitchAccount' | 'ChooseAccountForm' | 'Settings' | 'Notification';
        withPassword: boolean;
    };
    'account:loggedOut': {
        logContext: 'SwitchAccount' | 'Settings' | 'SignupQueued' | 'Deactivated' | 'Takendown';
        scope: 'current' | 'every';
    };
    ...
    'signup:handleSuggestionSelected': {
        method: string;
    };
    ...
    'profile:follow': {
        ...
        logContext: 'RecommendedFollowsItem' | 'PostThreadItem' | 'ProfileCard' | 'ProfileHeader' | 'ProfileHeaderSuggestedFollows' | 'ProfileMenu' | 'ProfileHoverCard' | 'AvatarButton' | 'StarterPackProfilesList' | 'FeedInterstitial' | 'ProfileHeaderSuggestedFollows' | 'PostOnboardingFindFollows' | 'ImmersiveVideo' | 'ExploreSuggestedAccounts' | 'OnboardingSuggestedAccounts';
    };
    'suggestedUser:follow': {
        logContext: 'Explore' | 'InterstitialDiscover' | 'InterstitialProfile' | 'Profile' | 'Onboarding';
        location: 'Card' | 'Profile';
        recId?: number;
        position: number;
    };
    'suggestedUser:press': {
        logContext: 'Explore' | 'InterstitialDiscover' | 'InterstitialProfile' | 'Onboarding';
        recId?: number;
        position: number;
    };
    'suggestedUser:seen': {
    ...
    'profile:unfollow': {
        logContext: 'RecommendedFollowsItem' | 'PostThreadItem' | 'ProfileCard' | 'ProfileHeader' | 'ProfileHeaderSuggestedFollows' | 'ProfileMenu' | 'ProfileHoverCard' | 'Chat' | 'AvatarButton' | 'StarterPackProfilesList' | 'FeedInterstitial' | 'ProfileHeaderSuggestedFollows' | 'PostOnboardingFindFollows' | 'ImmersiveVideo' | 'ExploreSuggestedAccounts' | 'OnboardingSuggestedAccounts';
    };
    'chat:create': {
        logContext: 'ProfileHeader' | 'NewChatDialog' | 'SendViaChatDialog';
    };
    'chat:open': {
        logContext: 'ProfileHeader' | 'NewChatDialog' | 'ChatsList' | 'SendViaChatDialog';
    };
    'starterPack:share': {
        starterPack: string;
    ...
    'test:all:always': {};
    'test:all:sometimes': {};
    'test:all:boosted_by_gate1': {
        reason: 'base' | 'gate1';
    };
    'test:all:boosted_by_gate2': {
        reason: 'base' | 'gate2';
    };
    'test:all:boosted_by_both': {
        reason: 'base' | 'gate1' | 'gate2';
    };
    'test:gate1:always': {};
    ...
    'explore:module:seen': {
        module: 'trendingTopics' | 'trendingVideos' | 'suggestedAccounts' | 'suggestedFeeds' | 'suggestedStarterPacks' | `feed:${FeedDescriptor}`;
    };
    ...
    'verification:learn-more': {
        location: 'initialAnnouncementeNux' | 'verificationsDialog' | 'verifierDialog' | 'verificationSettings';
    };
