...
export function createComposerState({ initText, initMention, initImageUris, initQuoteUri, initInteractionSettings, }) {
    let media;
    ...
    if (initText) {
        ...
        const detectedExtUris = new Map();
        const detectedPostUris = new Map();
        ...
        const pastSuggestedUris = new Set();
