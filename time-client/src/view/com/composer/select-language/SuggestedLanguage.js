...
export function SuggestedLanguage({ text, replyToLanguage: replyToLanguageProp, }) {
    const replyToLanguage = cleanUpLanguage(replyToLanguageProp);
    const [suggestedLanguage, setSuggestedLanguage] = useState(text.length === 0 ? replyToLanguage : undefined);
    ...
    if (suggestedLanguage &&
        ...
        return (_jsxs(View, { style: [
                ...
                a.my_sm,
                t.atoms.bg,
            ], children: [_jsx(EarthIcon, {}), _jsx(Text, { style: [a.flex_1], children: _jsxs(Trans, { children: ["Are you writing in", ' ', _jsx(Text, { style: [a.font_bold], children: suggestedLanguageName }), "?"] }) }), _jsx(Button, { color: "secondary", size: "small", variant: "solid", onPress: () => setLangPrefs.setPostLanguage(suggestedLanguage), label: _(msg `Change post language to ${suggestedLanguageName}`), children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Yes" }) }) })] }));
    }
    else {
        return null;
    }
...
//# sourceMappingURL=SuggestedLanguage.js.map