...
import {} from './web/EmojiPicker';
import { LinkDecorator } from './web/LinkDecorator';
import { TagDecorator } from './web/TagDecorator';
export function TextInput({ ref, richtext, placeholder, webForceMinHeight, hasRightPadding, isActive, setRichText, onPhotoPasted, onPressPublish, onNewLink, onFocus, }) {
    ...
    useEffect(() => {
        ...
        const handleDrop = (event) => {
            ...
            if (transfer) {
                ...
                getImageOrVideoFromUri(items, (uri) => {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            ...
            handlePaste: (view, event) => {
                ...
                if (clipboardData) {
                    ...
                    getImageOrVideoFromUri(clipboardData.items, (uri) => {
                        textInputWebEmitter.emit('media-pasted', uri);
                    });
                    if (preventDefault) {
        ...
        onUpdate({ editor: editorProp }) {
            ...
            const suggestedUri = suggestLinkCardUri(isPaste, nextDetectedUris, prevDetectedUris.current, pastSuggestedUris.current);
    ...
    const onEmojiInserted = useCallback((emoji) => {
...
//# sourceMappingURL=TextInput.web.js.map