...
export function LoadLatestBtn({ onPress, label, showIndicator, }) {
    ...
    return (_jsx(Animated.View, { testID: "loadLatestBtn", style: [
            ...
            ], onPress: onPress, hitSlop: HITSLOP_20, accessibilityLabel: label, accessibilityHint: "", targetScale: 0.9, onPointerEnter: onHoverIn, onPointerLeave: onHoverOut, children: [_jsx(SubtleWebHover, { hover: hovered, style: [a.rounded_full] }), _jsx(ArrowIcon, { size: "md", style: [
                        a.z_10,
                        showIndicator
...
//# sourceMappingURL=LoadLatestBtn.js.map