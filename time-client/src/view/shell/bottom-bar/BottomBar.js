...
export function BottomBar({ navigation }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SwitchAccountDialog, { control: accountSwitchControl }), _jsx(Animated.View, { style: [
                    ...
                    footerHeight.set(e.nativeEvent.layout.height);
                }, children: hasSession ? (_jsxs(_Fragment, { children: [_jsx(Btn, { testID: "bottomBarHomeBtn", icon: isAtHome ? (_jsx(HomeFilled, { width: iconWidth + 1, style: [styles.ctrlIcon, pal.text, styles.homeIcon] })) : (_jsx(Home, { width: iconWidth + 1, style: [styles.ctrlIcon, pal.text, styles.homeIcon] })), hasNew: hasHomeBadge && gate('remove_show_latest_button'), onPress: onPressHome, accessibilityRole: "tab", accessibilityLabel: _(msg `Home`), accessibilityHint: "" }), _jsx(Btn, { icon: isAtSearch ? (_jsx(MagnifyingGlassFilled, { width: iconWidth + 2, style: [styles.ctrlIcon, pal.text, styles.searchIcon] })) : (_jsx(MagnifyingGlass, { testID: "bottomBarSearchBtn", width: iconWidth + 2, style: [styles.ctrlIcon, pal.text, styles.searchIcon] })), onPress: onPressSearch, accessibilityRole: "search", accessibilityLabel: _(msg `Search`), accessibilityHint: "" }), _jsx(Btn, { testID: "bottomBarMessagesBtn", icon: isAtMessages ? (_jsx(MessageFilled, { width: iconWidth - 1, style: [styles.ctrlIcon, pal.text, styles.feedsIcon] })) : (_jsx(Message, { width: iconWidth - 1, style: [styles.ctrlIcon, pal.text, styles.feedsIcon] })), onPress: onPressMessages, notificationCount: numUnreadMessages.numUnread, hasNew: numUnreadMessages.hasNew, accessible: true, accessibilityRole: "tab", accessibilityLabel: _(msg `Chat`), accessibilityHint: numUnreadMessages.count > 0
                                ? _(msg `${plural(numUnreadMessages.numUnread ?? 0, {
                                    one: '# unread item',
                                    other: '# unread items',
                                })}` || '')
                                ...
                                : _(msg `${plural(numUnreadNotifications ?? 0, {
                                    ...
                                    other: '# unread items',
                                    ...
                                    ], children: _jsx(UserAvatar, { avatar: demoMode ? BOTTOM_BAR_AVI : profile?.avatar, size: iconWidth - 2, 
                                        // See https://github.com/bluesky-social/social-app/pull/1801:
                                        usePlainRNImage: true, type: profile?.associated?.labeler ? 'labeler' : 'user', live: live, hideLiveBadge: true }) })) : (_jsx(View, { style: [
                                        styles.ctrlIcon,
                                        pal.text,
                                        styles.profileIcon,
                                        {
                                        ...
                                        // See https://github.com/bluesky-social/social-app/pull/1801:
                                        usePlainRNImage: true, type: profile?.associated?.labeler ? 'labeler' : 'user', live: live, hideLiveBadge: true }) })) }), onPress: onPressProfile, onLongPress: onLongPressProfile, accessibilityRole: "tab", accessibilityLabel: _(msg `Profile`), accessibilityHint: "" })] })) : (_jsx(_Fragment, { children: _jsxs(View, { style: {
                            width: '100%',
                            flexDirection: 'row',
                            alignItems: 'center',
                            ...
                            paddingRight: 6,
                            gap: 8,
                        }, children: [_jsxs(View, { style: { flexDirection: 'row', alignItems: 'center', gap: 8 }, children: [_jsx(Logo, { width: 28 }), _jsx(View, { style: { paddingTop: 4 }, children: _jsx(Logotype, { width: 80, fill: pal.text.color }) })] }), _jsxs(View, { style: [a.flex_row, a.flex_wrap, a.gap_sm], children: [_jsx(Button, { onPress: showCreateAccount, label: _(msg `Create account`), size: "small", variant: "solid", color: "primary", children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Create account" }) }) }), _jsx(Button, { onPress: showSignIn, label: _(msg `Sign in`), size: "small", variant: "solid", color: "secondary", children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Sign in" }) }) })] })] }) })) })] }));
}
function Btn({ testID, icon, hasNew, notificationCount, onPress, onLongPress, accessible, accessibilityHint, accessibilityLabel, }) {
    return (_jsxs(PressableScale, { testID: testID, style: [styles.ctrl, a.flex_1], onPress: onPress, onLongPress: onLongPress, accessible: accessible, accessibilityLabel: accessibilityLabel, accessibilityHint: accessibilityHint, targetScale: 0.8, children: [icon, notificationCount ? (_jsx(View, { style: [styles.notificationCount, a.rounded_full], children: _jsx(Text, { style: styles.notificationCountLabel, children: notificationCount }) })) : hasNew ? (_jsx(View, { style: [styles.hasNewBadge, a.rounded_full] })) : null] }));
}
