...
export const AnimatedCheck = React.forwardRef(function AnimatedCheck({ playOnMount, ...props }, ref) {
    ...
    const play = React.useCallback((cb) => {
        circleAnim.set(0);
        checkAnim.set(0);
