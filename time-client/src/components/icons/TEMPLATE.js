...
export const IconTemplate_Stroke2_Corner0_Rounded = React.forwardRef(function LogoImpl(props, ref) {
    const { fill, size, style, ...rest } = useCommonSVGProps(props);
    return (_jsx(Svg, { fill: "none", ...rest, 
...
export function createSinglePathSVG({ path }) {
    return React.forwardRef(function LogoImpl(props, ref) {
        ...
        return (_jsxs(Svg, { fill: "none", ...rest, ref: ref, viewBox: "0 0 24 24", width: size, height: size, style: [style], children: [gradient, _jsx(Path, { fill: fill, fillRule: "evenodd", clipRule: "evenodd", d: path })] }));
    });
}
export function createMultiPathSVG({ paths }) {
    return React.forwardRef(function LogoImpl(props, ref) {
        const { fill, size, style, gradient, ...rest } = useCommonSVGProps(props);
        return (_jsxs(Svg, { fill: "none", ...rest, ref: ref, viewBox: "0 0 24 24", width: size, height: size, style: [style], children: [gradient, paths.map((path, i) => (_jsx(Path, { fill: fill, fillRule: "evenodd", clipRule: "evenodd", d: path }, i)))] }));
    });
}
