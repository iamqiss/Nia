...
export function NewChat({ control, onNewChat, }) {
    const t = useTheme();
    const { _ } = useLingui();
    ...
    return (_jsxs(_Fragment, { children: [_jsx(FAB, { testID: "newChatFAB", onPress: wrappedOnPress, icon: _jsx(Plus, { size: "lg", fill: t.palette.white }), accessibilityRole: "button", accessibilityLabel: _(msg `New chat`), accessibilityHint: "" }), _jsxs(Dialog.Outer, { control: control, testID: "newChatDialog", children: [_jsx(Dialog.Handle, {}), _jsx(SearchablePeopleList, { title: _(msg `Start a new chat`), onSelectChat: onCreateChat, sortByMessageDeclaration: true })] })] }));
}
//# sourceMappingURL=NewChatDialog.js.map