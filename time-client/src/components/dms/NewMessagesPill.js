...
export function NewMessagesPill({ onPress: onPressInner, }) {
    const t = useTheme();
    ...
    return (_jsx(View, { style: [
            ...
            a.align_center,
            {
                ...
                animatedStyle,
            ], entering: ScaleAndFadeIn, exiting: ScaleAndFadeOut, onPress: onPress, onPressIn: onPressIn, onPressOut: onPressOut, children: _jsx(Text, { style: [a.font_bold], children: _jsx(Trans, { children: "New messages" }) }) }) }));
}
//# sourceMappingURL=NewMessagesPill.js.map