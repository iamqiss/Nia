...
export function ChatEmptyPill() {
    ...
    return (_jsx(View, { style: [
            ...
            a.align_center,
            {
                ...
                a.align_center,
                animatedStyle,
            ], entering: ScaleAndFadeIn, exiting: ShrinkAndPop, onPress: onPress, onPressIn: onPressIn, onPressOut: onPressOut, children: _jsx(Text, { style: [a.font_bold, a.pointer_events_none], selectable: false, children: prompts[promptIndex] }) }) }));
}
//# sourceMappingURL=ChatEmptyPill.js.map