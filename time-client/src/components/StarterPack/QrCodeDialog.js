...
export function QrCodeDialog({ starterPack, link, control, }) {
    ...
    return (_jsxs(Dialog.Outer, { control: control, nativeOptions: { preventExpansion: true }, children: [_jsx(Dialog.Handle, {}), _jsxs(Dialog.ScrollableInner, { label: _(msg `Create a QR code for a starter pack`), children: [_jsx(View, { style: [a.flex_1, a.align_center, a.gap_5xl], children: _jsx(Suspense, { fallback: _jsx(Loading, {}), children: !link ? (_jsx(Loading, {})) : (_jsxs(_Fragment, { children: [_jsx(QrCode, { starterPack: starterPack, link: link, ref: ref }), _jsxs(View, { style: [
                                            a.w_full,
                                            a.gap_md,
                                            gtMobile && [a.flex_row, a.justify_center, a.flex_wrap],
                                        ], children: [_jsxs(Button, { label: _(msg `Copy QR code`), color: "primary_subtle", size: "large", onPress: isWeb ? onCopyPress : onSharePress, children: [_jsx(ButtonIcon, { icon: isCopyProcessing
                                                            ? Loader
                                                            : isWeb
                                                                ? ChainLinkIcon
                                                                : ShareIcon }), _jsx(ButtonText, { children: isWeb ? _jsx(Trans, { children: "Copy" }) : _jsx(Trans, { children: "Share" }) })] }), _jsxs(Button, { label: _(msg `Save QR code`), color: "secondary", size: "large", onPress: onSavePress, children: [_jsx(ButtonIcon, { icon: isSaveProcessing ? Loader : FloppyDiskIcon }), _jsx(ButtonText, { children: _jsx(Trans, { children: "Save" }) })] })] })] })) }) }), _jsx(Dialog.Close, {})] })] }));
}
function Loading() {
    return (_jsx(View, { style: [a.align_center, a.justify_center, { minHeight: 400 }], children: _jsx(Loader, { size: "xl" }) }));
}
//# sourceMappingURL=QrCodeDialog.js.map