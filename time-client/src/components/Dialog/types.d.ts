import { type AccessibilityProps, type GestureResponderEvent, type ScrollViewProps, type StyleProp, type ViewStyle } from 'react-native';
...
export type DialogInnerProps = DialogInnerPropsBase<{
    label?: undefined;
