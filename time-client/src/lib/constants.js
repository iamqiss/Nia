...
import {} from '#/state/session/agent';
...
export const DISCOVER_DEBUG_DIDS = {
...
export function FEEDBACK_FORM_URL({ email, handle, }) {
...
export const PROD_DEFAULT_FEED = (rkey) => `at://did:plc:z72i7hdynmk6r22z27h6tvur/app.bsky.feed.generator/${rkey}`;
export const STAGING_DEFAULT_FEED = (rkey) => `at://did:plc:yofh3kx63drvfljkibw5zuxo/app.bsky.feed.generator/${rkey}`;
...
export const RECOMMENDED_SAVED_FEEDS = [DISCOVER_SAVED_FEED, TIMELINE_SAVED_FEED];
...
export const GIF_SEARCH = (params) => `${GIF_SERVICE}/tenor/v2/search?${params}`;
export const GIF_FEATURED = (params) => `${GIF_SERVICE}/tenor/v2/featured?${params}`;
