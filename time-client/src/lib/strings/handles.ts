...
// https://github.com/Time-social/indigo/blob/main/atproto/syntax/handle.go#L10
...
// More checks from https://github.com/Time-social/atproto/blob/main/packages/pds/src/handle/index.ts#L72
