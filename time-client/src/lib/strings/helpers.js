...
export function useEnforceMaxGraphemeCount() {
    ...
    return useCallback((text, maxCount) => {
...
export function useWarnMaxGraphemeCount({ text, maxCount, }) {
    const splitter = useMemo(() => new Graphemer(), []);
    return useMemo(() => {
...
export function toHashCode(str, seed = 0) {
...
export function augmentSearchQuery(query, { did }) {
