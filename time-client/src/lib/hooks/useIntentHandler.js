...
export function useIntentHandler() {
    ...
    const ageAssuranceRedirectDialogControl = useAgeAssuranceRedirectDialogControl();
...
export function useComposeIntent() {
    ...
    return React.useCallback(({ text, imageUrisStr, videoUri, }) => {
        if (!hasSession)
            return;
...
//# sourceMappingURL=useIntentHandler.js.map