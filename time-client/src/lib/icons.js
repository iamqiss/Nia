...
export function MagnifyingGlassIcon({ style, size, strokeWidth = 2, color = 'currentColor', }) {
...
export function MagnifyingGlassIcon2({ style, size, strokeWidth = 2, }) {
...
export function CogIcon({ style, size, strokeWidth = 1.5, }) {
...
// Copyright (c) 2020 Refactoring UI Inc.
// https://github.com/tailwindlabs/heroicons/blob/master/LICENSE
export function UserGroupIcon({ style, size, }) {
...
export function SquareIcon({ style, size, strokeWidth = 1.3, }) {
...
export function RectWideIcon({ style, size, strokeWidth = 1.3, }) {
...
export function RectTallIcon({ style, size, strokeWidth = 1.3, }) {
...
export function ComposeIcon2({ style, size, strokeWidth = 1.5, }) {
...
export function InfoCircleIcon({ style, size, strokeWidth = 1.5, }) {
...
export function HandIcon({ style, size, strokeWidth = 1.5, }) {
...
export function HashtagIcon({ style, size, strokeWidth = 1.5, }) {
...
// Copyright (c) 2020 Refactoring UI Inc.
// https://github.com/tailwindlabs/heroicons/blob/master/LICENSE
export function ShieldExclamation({ style, size, strokeWidth = 1.5, }) {
