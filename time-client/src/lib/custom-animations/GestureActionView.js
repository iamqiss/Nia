...
const ICON_SIZE = 32;
export function GestureActionView({ children, actions, }) {
    ...
    return (_jsx(GestureDetector, { gesture: composedGesture, children: _jsxs(View, { children: [_jsx(Animated.View, { style: [StyleSheet.absoluteFill, animatedBackgroundStyle], children: _jsx(View, { style: {
                            ...
                            alignItems: activeAction === 'leftFirst' || activeAction === 'leftSecond'
                                ? 'flex-end'
                                : 'flex-start',
                        }, children: _jsx(Animated.View, { style: [animatedIconStyle], children: activeAction === 'leftFirst' && actions.leftFirst?.icon ? (_jsx(actions.leftFirst.icon, { height: ICON_SIZE, width: ICON_SIZE, style: {
                                    color: 'white',
                                } })) : activeAction === 'leftSecond' && actions.leftSecond?.icon ? (_jsx(actions.leftSecond.icon, { height: ICON_SIZE, width: ICON_SIZE, style: { color: 'white' } })) : activeAction === 'rightFirst' && actions.rightFirst?.icon ? (_jsx(actions.rightFirst.icon, { height: ICON_SIZE, width: ICON_SIZE, style: { color: 'white' } })) : activeAction === 'rightSecond' &&
                                actions.rightSecond?.icon ? (_jsx(actions.rightSecond.icon, { height: ICON_SIZE, width: ICON_SIZE, style: { color: 'white' } })) : null }) }) }), _jsx(Animated.View, { style: animatedSliderStyle, children: children })] }) }));
}
function createInterpolation({ firstColor, secondColor, firstThreshold, secondThreshold, side, }) {
...
//# sourceMappingURL=GestureActionView.js.map