...
export async function resolveLink(agent, uri) {
    if (isShortLink(uri)) {
    ...
    async function fetchDid(handleOrDid) {
...
export async function resolveGif(agent, gif) {
...
async function resolveExternal(agent, uri) {
...
export async function imageToThumb(imageUri) {
    try {
