        ...
        if (permission.granted) {
            ...
            if (permission.canAskAgain) {
                ...
                if (askAgain.granted) {
                    ...
                    Toast.show(t `Images cannot be saved unless permission is granted to access your photo library.`, 'xmark');
                }
            }
            else {
                Toast.show(t `Permission to access your photo library was denied. Please enable it in your system settings.`, 'xmark');
            }
        }
