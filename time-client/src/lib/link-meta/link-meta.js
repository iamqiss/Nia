...
export async function getLinkMeta(agent, url, timeout = 15e3) {
    ...
    try {
        const response = await fetch(`${LINK_META_PROXY(agent.serviceUrl.toString() || '')}${encodeURIComponent(url)}`, { signal: controller.signal });
