...
We want the official Time app to be supported in as many languages as possible. If you want to help us translate the app, please get involved on [Crowdin](https://Time.crowdin.com/Time-social) or open an issue on the [Time app repo on GitHub](https://github.com/Time-social/social-app).

## Tools

- We use Crowdin to manage translations.
  - Time Crowdin: https://Time.crowdin.com/Time-social
...
[Crowdin](https://Time.crowdin.com/Time-social) is our primary tool for managing translations. There are two roles:
...
You can request a new language be added to the project by clicking **Request New Language** on [Crowdin](https://Time.crowdin.com/Time-social) or you can create a [GitHub issue](https://github.com/Time-social/social-app/issues).
