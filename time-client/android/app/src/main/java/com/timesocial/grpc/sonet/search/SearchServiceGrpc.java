...
@javax.annotation.Generated(
    ...
    comments = "Source: services/search.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class SearchServiceGrpc {

  private SearchServiceGrpc() {}

  public static final String SERVICE_NAME = "sonet.search.SearchService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<sonet.search.Search.SearchUserRequest,
      sonet.search.Search.SearchUserResponse> getSearchUsersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SearchUsers",
      requestType = sonet.search.Search.SearchUserRequest.class,
      responseType = sonet.search.Search.SearchUserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sonet.search.Search.SearchUserRequest,
      sonet.search.Search.SearchUserResponse> getSearchUsersMethod() {
    io.grpc.MethodDescriptor<sonet.search.Search.SearchUserRequest, sonet.search.Search.SearchUserResponse> getSearchUsersMethod;
      ...
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchUsersMethod = SearchServiceGrpc.getSearchUsersMethod) == null) {
          SearchServiceGrpc.getSearchUsersMethod = getSearchUsersMethod =
              io.grpc.MethodDescriptor.<sonet.search.Search.SearchUserRequest, sonet.search.Search.SearchUserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SearchUsers"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sonet.search.Search.SearchUserRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sonet.search.Search.SearchUserResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<sonet.search.Search.SearchNoteRequest,
      sonet.search.Search.SearchNoteResponse> getSearchNotesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SearchNotes",
      requestType = sonet.search.Search.SearchNoteRequest.class,
      responseType = sonet.search.Search.SearchNoteResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sonet.search.Search.SearchNoteRequest,
      sonet.search.Search.SearchNoteResponse> getSearchNotesMethod() {
    io.grpc.MethodDescriptor<sonet.search.Search.SearchNoteRequest, sonet.search.Search.SearchNoteResponse> getSearchNotesMethod;
    if ((getSearchNotesMethod = SearchServiceGrpc.getSearchNotesMethod) == null) {
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchNotesMethod = SearchServiceGrpc.getSearchNotesMethod) == null) {
          SearchServiceGrpc.getSearchNotesMethod = getSearchNotesMethod =
              io.grpc.MethodDescriptor.<sonet.search.Search.SearchNoteRequest, sonet.search.Search.SearchNoteResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SearchNotes"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sonet.search.Search.SearchNoteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sonet.search.Search.SearchNoteResponse.getDefaultInstance()))
              .setSchemaDescriptor(new SearchServiceMethodDescriptorSupplier("SearchNotes"))
              .build();
        }
      }
    }
  ...
  public static abstract class SearchServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void searchUsers(sonet.search.Search.SearchUserRequest request,
        io.grpc.stub.StreamObserver<sonet.search.Search.SearchUserResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSearchUsersMethod(), responseObserver);
    }

    /**
     */
    public void searchNotes(sonet.search.Search.SearchNoteRequest request,
        io.grpc.stub.StreamObserver<sonet.search.Search.SearchNoteResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                sonet.search.Search.SearchUserRequest,
                sonet.search.Search.SearchUserResponse>(
                  this, METHODID_SEARCH_USERS)))
          .addMethod(
            getSearchNotesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                sonet.search.Search.SearchNoteRequest,
                sonet.search.Search.SearchNoteResponse>(
  ...
  public static final class SearchServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SearchServiceBlockingStub> {
    ...
    /**
     */
    public sonet.search.Search.SearchUserResponse searchUsers(sonet.search.Search.SearchUserRequest request) {
    ...
    /**
     */
    public sonet.search.Search.SearchNoteResponse searchNotes(sonet.search.Search.SearchNoteRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SearchServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SearchServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sonet.search.Search.SearchUserResponse> searchUsers(
        sonet.search.Search.SearchUserRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sonet.search.Search.SearchNoteResponse> searchNotes(
        sonet.search.Search.SearchNoteRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getSearchNotesMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_SEARCH_USERS = 0;
  private static final int METHODID_SEARCH_NOTES = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH_USERS:
          serviceImpl.searchUsers((sonet.search.Search.SearchUserRequest) request,
              (io.grpc.stub.StreamObserver<sonet.search.Search.SearchUserResponse>) responseObserver);
          break;
        case METHODID_SEARCH_NOTES:
          serviceImpl.searchNotes((sonet.search.Search.SearchNoteRequest) request,
              (io.grpc.stub.StreamObserver<sonet.search.Search.SearchNoteResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SearchServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return sonet.search.Search.getDescriptor();
    }
