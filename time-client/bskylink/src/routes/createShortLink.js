...
export default function (ctx, app) {
    return app.post('/link', bodyParser.json(), handler(async (req, res) => {
        let path;
...
const ensureLink = async (ctx, type, parts) => {
...
const normalizedPathFromParts = (parts) => {
...
//# sourceMappingURL=createShortLink.js.map